...
public class RedRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:red_rough_concrete")
	public static final Block block = null;

	public RedRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("red_rough_concrete");
		}
