...
public class YellowRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:yellow_rough_concrete")
	public static final Block block = null;

	public YellowRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("yellow_rough_concrete");
		}
