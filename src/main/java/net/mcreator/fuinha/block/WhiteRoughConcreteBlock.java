...
public class WhiteRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:white_rough_concrete")
	public static final Block block = null;

	public WhiteRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("white_rough_concrete");
		}
