...
public class LimeRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:lime_rough_concrete")
	public static final Block block = null;

	public LimeRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("lime_rough_concrete");
		}
