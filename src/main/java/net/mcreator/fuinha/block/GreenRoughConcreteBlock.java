...
public class GreenRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:green_rough_concrete")
	public static final Block block = null;

	public GreenRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("green_rough_concrete");
		}
