...
import net.mcreator.fuinha.procedures.RoughConcreteExplosionProcedure;
...
public class LightBlueRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:light_blue_rough_concrete")
	public static final Block block = null;

	public LightBlueRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("light_blue_rough_concrete");
		}
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			RoughConcreteExplosionProcedure.executeProcedure(Stream
