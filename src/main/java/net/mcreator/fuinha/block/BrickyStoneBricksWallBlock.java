...
import net.mcreator.fuinha.procedures.BrickyStoneBricksWallBlockDestroyedByExplosionProcedure;
...
public class BrickyStoneBricksWallBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:bricky_stone_bricks_wall")
	public static final Block block = null;

	public BrickyStoneBricksWallBlock(FuinhaModElements instance) {
		super(instance, 179);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("bricky_stone_bricks_wall");
		}
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			BrickyStoneBricksWallBlockDestroyedByExplosionProcedure.executeProcedure(Stream
