...
public class MagentaRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:magenta_rough_concrete")
	public static final Block block = null;

	public MagentaRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("magenta_rough_concrete");
		}
