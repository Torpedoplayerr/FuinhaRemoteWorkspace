...
public class OrangeRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:orange_rough_concrete")
	public static final Block block = null;

	public OrangeRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("orange_rough_concrete");
		}
