...
public class RoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:rough_concrete")
	public static final Block block = null;

	public RoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("rough_concrete");
		}
