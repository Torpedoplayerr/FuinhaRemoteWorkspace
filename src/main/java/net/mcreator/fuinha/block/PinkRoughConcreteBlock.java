...
public class PinkRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:pink_rough_concrete")
	public static final Block block = null;

	public PinkRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("pink_rough_concrete");
		}
