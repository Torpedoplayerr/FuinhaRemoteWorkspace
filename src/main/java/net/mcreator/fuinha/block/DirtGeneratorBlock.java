...
import net.mcreator.fuinha.procedures.DirtGeneratorUpdateTickProcedure;
import net.mcreator.fuinha.itemgroup.FuinhaItemGroup;
import net.mcreator.fuinha.gui.DirtGeneratorGUiGui;
...
public class DirtGeneratorBlock extends FuinhaModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			DirtGeneratorUpdateTickProcedure.executeProcedure(Stream
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Dirt Generator");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new DirtGeneratorGUiGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new DirtGeneratorGUiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
