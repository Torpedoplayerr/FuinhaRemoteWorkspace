...
public class BlueRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:blue_rough_concrete")
	public static final Block block = null;

	public BlueRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("blue_rough_concrete");
		}
