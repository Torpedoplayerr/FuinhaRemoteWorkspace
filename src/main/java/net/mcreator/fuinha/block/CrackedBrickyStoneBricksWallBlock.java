...
import net.mcreator.fuinha.procedures.CrackedBrickyStoneBricksWallBlockDestroyedByExplosionProcedure;
...
public class CrackedBrickyStoneBricksWallBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:cracked_bricky_stone_bricks_wall")
	public static final Block block = null;

	public CrackedBrickyStoneBricksWallBlock(FuinhaModElements instance) {
		super(instance, 180);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("cracked_bricky_stone_bricks_wall");
		}
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			CrackedBrickyStoneBricksWallBlockDestroyedByExplosionProcedure.executeProcedure(Stream
