...
public class BrownRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:brown_rough_concrete")
	public static final Block block = null;

	public BrownRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("brown_rough_concrete");
		}
