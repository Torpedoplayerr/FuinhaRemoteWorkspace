...
public class CyanRoughConcreteBlock extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:cyan_rough_concrete")
	public static final Block block = null;

	public CyanRoughConcreteBlock(FuinhaModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("cyan_rough_concrete");
		}
