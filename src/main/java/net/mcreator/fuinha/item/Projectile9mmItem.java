...
import net.mcreator.fuinha.procedures.Projectile9mmProjectileHitsLivingEntityProcedure;
import net.mcreator.fuinha.procedures.Projectile9mmProjectileHitsBlockProcedure;
import net.mcreator.fuinha.entity.renderer.Projectile9mmRenderer;
...
public class Projectile9mmItem extends FuinhaModElements.ModElement {
	@ObjectHolder("fuinha:projectile_9mm")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_projectile_9mm").setRegistryName("projectile_projectile_9mm");

	public Projectile9mmItem(FuinhaModElements instance) {
		super(instance, 12);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Projectile9mmRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("projectile_9mm");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onEntityHit(EntityRayTraceResult entityRayTraceResult) {
			...
			Projectile9mmProjectileHitsLivingEntityProcedure.executeProcedure(Stream
		...
		public void func_230299_a_(BlockRayTraceResult blockRayTraceResult) {
			...
			Projectile9mmProjectileHitsBlockProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
